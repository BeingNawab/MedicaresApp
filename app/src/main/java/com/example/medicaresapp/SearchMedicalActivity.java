...
public class SearchMedicalActivity extends AppCompatActivity {
    ...
    private void loadData(String data) {
        Query query=databaseReference.orderByChild("CityName").startAt(data).endAt(data+"\uf8ff");
            ...
            protected void onBindViewHolder(@NonNull MyViewHolder myViewHolder, int i, @NonNull Model model) {
                ...
                myViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent ratingIntent=new Intent(SearchMedicalActivity.this,RatingActivity.class);
